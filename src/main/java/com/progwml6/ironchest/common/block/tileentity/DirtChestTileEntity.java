...
public class DirtChestTileEntity extends GenericIronChestTileEntity {
  ...
  public DirtChestTileEntity(BlockPos blockPos, BlockState blockState) {
    super(IronChestsTileEntityTypes.DIRT_CHEST.get(), blockPos, blockState, IronChestsTypes.DIRT, IronChestsBlocks.DIRT_CHEST::get);
  ...
  public void removeAdornments() {
    if (!this.getItems().get(0).isEmpty() && this.getItems().get(0).sameItemStackIgnoreDurability(dirtChest9000GuideBook)) {
